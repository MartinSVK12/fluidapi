...
import net.minecraft.src.mod_FluidAPI;
...
public class Config {
    ...
    private static File configFile = new File((Minecraft.getMinecraftDir()) + "/config/FluidAPI.cfg");
}

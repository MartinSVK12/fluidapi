        ...
        if(slot != null){
            ...
            if(inventoryPlayer.getHeldItemStack() != null && inventoryPlayer.getHeldItemStack().getItem() instanceof IItemFluidContainer) {
                ...
                if(FluidAPI.fluidRegistry.fluids.get(item) != null || FluidAPI.fluidRegistry.fluidContainers.containsValue(item)){
                    if(tile.acceptedFluids.get(slotID).isEmpty() || tile.acceptedFluids.get(slotID).contains(FluidAPI.fluidRegistry.fluids.get(item)) || (slot.getFluidStack() != null && (IItemFluidContainer) (FluidAPI.fluidRegistry.fluidContainers.get(FluidAPI.fluidRegistry.fluidsInv.get(slot.getFluidStack().liquid))) == item)){
